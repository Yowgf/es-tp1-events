     ...
     render() {
        return (
           <div id="table">
              ...
              <button onClick={() => this.setState({page: this.state.page + 1})} disabled={this.state.page >=1}>
                {' > '}
              </button>
           </div>
        )
